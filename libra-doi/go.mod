...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatchevents v1.23.2 // indirect
	...
	github.com/uvalib/easystore/uvaeasystore v0.0.0-20240314161028-c303dbcdcf98 // indirect
